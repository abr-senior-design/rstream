RStream: An ABR algorithm testing model based on AStream
==================
RStream is a Python based emulated video player to evaluate the performance of the DASH bitrate adaptation algorithms.


Rate Adaptation Algorithms Supported
--------------------------------------
1. Basic Adaptation
