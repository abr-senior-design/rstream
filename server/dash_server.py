...
MPD_FILES = ['sample_mpd/BigBuckBunny_4s.mpd']
HTML_404 = "404.html"
...
class MyHTTPRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if '@' in request:
            transfer_size = int(float((request.split('@')[1])))
            duration, file_size = dummy_reply(self.wfile, transfer_size)
            print "Request for file of size {}".format(file_size,)
